...
export function normalizeSubmasterValues(
	channelValue: number | BlenderValue,
...
export function normalizeChannel(
	...
	const channelValue = normalizeSubmasterValues(
		getChannelValue(profile, fixtureData, channel),
		channelInfo.default
	)
	switch (desiredScale) {
	case 'U8':
