...
const props = defineProps({
	...
	class: {
		required: false,
		type: undefined as unknown as PropType<string | string[] | Record<string, boolean>>
	},
...
.sdmx-dropdown-overlay-enter-from,
.sdmx-dropdown-overlay-leave-to {
	height: 0;
	box-shadow: var(--unfocused-shadow);
	scale: 0.75;
	transform: translate(0, 0);
}
.sdmx-dropdown-overlay-enter-to,
.sdmx-dropdown-overlay-leave-from {
	@include dropdown-animation-dest();
}
.sdmx-dropdown-overlay-enter-active,
.sdmx-dropdown-overlay-leave-active {
	transition:
		transform 200ms,
		margin-top 200ms,
		scale 200ms,
