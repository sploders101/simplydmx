use crate::utils::forms::FormDescriptor;
use simplydmx_plugin_framework::*;
use uuid::Uuid;

use super::{
	driver_plugin_api::SharablePatcherState,
	interface::{
		CreateFixtureError, DeleteFixtureError, EditFixtureError, GetCreationFormError,
		GetEditFormError, ImportFixtureError,
	},
	PatcherInterface,
};
...
impl EditFixture {
	...
	async fn main(
		...
		return self
			.0
			.edit_fixture(&instance_id, personality, name, comments, form_data)
			.await;
	}
}
