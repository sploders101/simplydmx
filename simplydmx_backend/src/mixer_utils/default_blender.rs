...
pub fn blend_fixture(
	...
	if let Some(fixture_blending_data) = data_sources.blending_data(fixture_id) {
				...
				match attribute_value {
					...
					BlenderValue::Offset(attribute_value) => {
						...
						*cumulative_attribute =
							new_value.clamp(u16::MIN as f64, u16::MAX as f64).round() as u16;
					}
...
pub fn blend_layer(
	...
	cumulative_layer
		.par_iter_mut()
		.for_each(|(fixture_id, cumulative_fixture)| {
