...
export type VisibleCGTypes = 'fader' | 'color' | 'position' | 'selections'
...
export type VisibleControlGroup<ControlType extends VisibleCGTypes = VisibleCGTypes> =
	ControlType extends VisibleCGTypes
		? {
				name: string
				type: ControlType
				controls: Array<{
