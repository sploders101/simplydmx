...
use crate::utils::id_alloc::LargeId;

#[portable]
pub type LightTypeId = Id;

#[portable]
pub type LightInstanceId = LargeId;

#[portable]
pub type LightAttributeId = SmartString<LazyCompact>;

/// Represents the data within a submaster used for blending
#[portable]
pub type SubmasterData = FxHashMap<LightInstanceId, AbstractLayerLight>;
...
#[portable]
pub type AbstractLayerLight = FxHashMap<LightAttributeId, BlenderValue>;
...
#[portable]
pub type FullMixerOutput = FxHashMap<LightInstanceId, FixtureMixerOutput>;

/// Represents the finished, pre-mixed values of a light.
#[portable]
pub type FixtureMixerOutput = FxHashMap<LightAttributeId, u16>;
...
/// Represents the data used to blend each channel.
pub type FullMixerBlendingData = FxHashMap<LightInstanceId, FxHashMap<LightAttributeId, BlendingData>>;
